...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(14);
...
function Todoform(props) {
    var handleTodo = props.handleTodo;
...
var tracking = __webpack_require__(26);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ponyfill_js__ = __webpack_require__(40);
/* global window */
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(12), __webpack_require__(39)(module)))
...
var _TodoItems = __webpack_require__(57);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(_TodoItems2.default, null),
...
exports.mapDispatchToProps = exports.TodoformCont = undefined;
...
var _Todoform = __webpack_require__(16);
...
var TodoformCont = exports.TodoformCont = function (_Component) {
    _inherits(TodoformCont, _Component);

    function TodoformCont() {
        _classCallCheck(this, TodoformCont);

        return _possibleConstructorReturn(this, (TodoformCont.__proto__ || Object.getPrototypeOf(TodoformCont)).apply(this, arguments));
    }

    _createClass(TodoformCont, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(_Todoform2.default, this.props);
        }
    }]);
...
var mapDispatchToProps = exports.mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        handleTodo: function handleTodo(payload) {
            dispatch((0, _index.addTodo)(payload));
        }
    };
};

exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(TodoformCont);
...
exports.mapStateToProps = exports.TodoItemsCont = undefined;
...
var _TodoItems = __webpack_require__(58);
...
var TodoItemsCont = exports.TodoItemsCont = function (_Component) {
  _inherits(TodoItemsCont, _Component);

  function TodoItemsCont() {
    _classCallCheck(this, TodoItemsCont);

    return _possibleConstructorReturn(this, (TodoItemsCont.__proto__ || Object.getPrototypeOf(TodoItemsCont)).apply(this, arguments));
  }

  _createClass(TodoItemsCont, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(_TodoItems2.default, this.props);
    }
  }]);

  return TodoItemsCont;
}(_react.Component);

var mapStateToProps = exports.mapStateToProps = function mapStateToProps(store) {
  return {
    items: store.todos
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(_TodoItems2.default);
...
var store = (0, _redux.createStore)(_reducers2.default); // Creates the store from the State received from the reducer(s)
...
var _todos = __webpack_require__(61);
...
function reducer() {
    ...
    switch (action.type) {
        case _actionTypes.ADD_TODO:
            return [].concat(_toConsumableArray(state), [{ text: action.payload }]);
        default:
            return state;
    }
}
